...
--|     "parameters_number": <sensor_type_list_msg_parnum>
--|   },
--|   "data": {
--|     "outcome": a_number,
--|     "message": "a_message",
	...
	to_json: STRING
		...
		do
			...
			if is_error_response then
				...
				json_representation.append (",%"parameters_number%": " + sensor_type_list_response_parnum.out)
				json_representation.append ("},")
				...
				parameters_number := sensor_type_list_response_parnum
				json_representation.append ("{")
				json_representation.append ("%"header%": {")
				json_representation.append ("%"id%": " + sensor_type_list_response_id.out)
				json_representation.append (",%"parameters_number%": " + sensor_type_list_response_parnum.out)
