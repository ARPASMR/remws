...
feature -- Logging
	...
	init_log
		...
		do
			--create log_path.make_from_string ("/home/meteo/dev/eiffel/collect/collect.log")
			create log_path.make_from_string ("/home/buck/dev/eiffel/gagliardo/eiffel/collect/collect.log")
			create logger.make
