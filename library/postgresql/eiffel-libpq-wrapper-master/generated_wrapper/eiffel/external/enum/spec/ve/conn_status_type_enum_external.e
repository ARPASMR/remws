...
feature {ANY}
	...
	connection_ok: INTEGER is
		external
			"C"
		alias
			"ewg_get_enum_ConnStatusType_member_CONNECTION_OK"
		end
	...
	connection_bad: INTEGER is
		external
			"C"
		alias
			"ewg_get_enum_ConnStatusType_member_CONNECTION_BAD"
		end
	...
	connection_started: INTEGER is
		external
			"C"
		alias
			"ewg_get_enum_ConnStatusType_member_CONNECTION_STARTED"
		end
	...
	connection_made: INTEGER is
		external
			"C"
		alias
			"ewg_get_enum_ConnStatusType_member_CONNECTION_MADE"
		end
	...
	connection_awaiting_response: INTEGER is
		external
			"C"
		alias
			"ewg_get_enum_ConnStatusType_member_CONNECTION_AWAITING_RESPONSE"
		end
	...
	connection_auth_ok: INTEGER is
		external
			"C"
		alias
			"ewg_get_enum_ConnStatusType_member_CONNECTION_AUTH_OK"
		end
	...
	connection_setenv: INTEGER is
		external
			"C"
		alias
			"ewg_get_enum_ConnStatusType_member_CONNECTION_SETENV"
		end
	...
	connection_ssl_startup: INTEGER is
		external
			"C"
		alias
			"ewg_get_enum_ConnStatusType_member_CONNECTION_SSL_STARTUP"
		end
	...
	connection_needed: INTEGER is
		external
			"C"
		alias
			"ewg_get_enum_ConnStatusType_member_CONNECTION_NEEDED"
		end
