...
feature -- Access
	...
	id:                  INTEGER do Result := logout_response_id + response_id_offset end
...
feature -- Conversion
	...
	to_json: STRING
		...
		do
			...
			Result.append (double_quotes + json_id_tag + double_quotes + colon + space + logout_response_id.out)
