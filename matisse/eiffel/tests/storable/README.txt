...
- Step 1:
   ...
   command:
   % mt_sdl stubgen --lang eiffel --storable -f $MATISSE_HOME/eiffel/tests/storable/test.odl
...
To compile the Eiffel project, open the test_suite.ecf file located in 
